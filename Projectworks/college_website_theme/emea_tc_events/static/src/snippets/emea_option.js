odoo.define('website.emea_dynamic_snippet_carousel_post', function (require) {
'use strict';

const options = require('web_editor.snippets.options');
const s_dynamic_snippet_options = require('website.s_dynamic_snippet_options');

const dynamicSnippetCarouselEmeaOptions = s_dynamic_snippet_carousel_emea_options.extend({
    /**
     * @override
     */
    onBuilt() {
        ...
        this.$target[0].dataset['snippet'] = 's_dynamic_snippet_carousel_emea';
    },
...
options.registry.dynamic_snippet_carousel_emea = dynamicSnippetCarouselEmeaOptions;

return dynamicSnippetCarouselEmeaOptions;
});
